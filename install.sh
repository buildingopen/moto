...
echo ""
info "Optional: Install the Mac iTerm tab workflow from this repo:"
echo "  bash mac/install.sh"
echo "  This installs claude-tabs plus ax/axo-style shell aliases."
echo ""
info "Optional: Add moto as the packaged remote orchestration layer:"
echo "  https://github.com/buildingopen/moto"
echo "  Use this when you want the same tab workflow plus reverse tunnel, SSHFS, health/status, and server bootstrap."
echo ""
echo ""
